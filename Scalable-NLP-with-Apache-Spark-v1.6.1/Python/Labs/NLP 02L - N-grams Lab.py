...
|moo1
%md Load in our tokenized and processed DataFrame.
...
**Hint:** You may want to take a look at <a href = "https://spark.apache.org/docs/latest/api/python/reference/api/pyspark.sql.functions.concat.html?highlight=concat#pyspark.sql.functions.concat" target="_blank"?> pyspark.sql.functions.concat</a>.
...
|moo1
%md What do you notice about the frequent n-grams? Could they be important in text processing?
